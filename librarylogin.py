...
label_softwarica = Label(root, text="Binod Library", font=("Helvetica", 24), fg="white", bg="#3b3b3b")
...
button_register = Button(login_frame, text="Register", command=register)
...
button_delete = Button(login_frame, text="Delete User", command=delete_user)
